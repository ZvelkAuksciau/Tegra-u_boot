 ...
 * Run "board-to-uboot.py kmti200-2180".
 */

#ifndef _PINMUX_CONFIG_KMTI200_2180_H_
#define _PINMUX_CONFIG_KMTI200_2180_H_
...
static const struct tegra_gpio_config kmti200_2180_gpio_inits[] = {
	/*        port, pin, init_val */
	GPIO_INIT(A,    5,   IN),
	GPIO_INIT(B,    0,   IN),
	GPIO_INIT(B,    1,   IN),
...
static const struct pmux_pingrp_config kmti200_2180_pingrps[] = {
...
static const struct pmux_drvgrp_config kmti200_2180_drvgrps[] = {
};

#endif /* PINMUX_CONFIG_KMTI200_2180_H */
