...
#include "pinmux-config-kmti200-2180.h"
...
void pinmux_init(void)
{
	...
	gpio_config_table(kmti200_2180_gpio_inits,
			  ARRAY_SIZE(kmti200_2180_gpio_inits));

	pinmux_config_pingrp_table(kmti200_2180_pingrps,
				   ARRAY_SIZE(kmti200_2180_pingrps));

	pinmux_config_drvgrp_table(kmti200_2180_drvgrps,
				   ARRAY_SIZE(kmti200_2180_drvgrps));
}
